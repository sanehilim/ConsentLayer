...
export function MarketplacePage() {
  ...
  const filtered = useMemo(() => available.filter((dataset) => `${dataset.name} ${dataset.description} ${dataset.type}`.toLowerCase().includes(query.trim().toLowerCase())), [available, query])
